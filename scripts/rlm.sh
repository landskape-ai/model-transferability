...
#SBATCH --output=/home/mila/d/diganta.misra/projects/ILM-VP/logs/1shot_baseline.out
#SBATCH --error=/home/mila/d/diganta.misra/projects/ILM-VP/logs/1shot_baseline.err
...
python3 /home/mila/d/diganta.misra/projects/ILM-VP/experiments/cnn/rlm_vp.py \
        --network LT \
        --dataset cifar10 \
