...
class WrappedLayer(nn.Module):
    ...
    def _mask_setter(self, new_mask, name='weight'):
        ...
        if self._copy_pruned:
            setattr(self, f'_{name}_data_copy',
                    self._build_pruned_copy(param,
                                            new_mask, param_data_copy))
    ...
    def revert_pruned(self):
        ...
        self.weight.data[revert_weight_mask] = self._weight_data_copy[revert_weight_mask]
