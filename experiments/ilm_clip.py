...
# from cfg import *
import wandb as wb
from tools.misc import gen_folder_name, set_seed,convert_models_to_fp32
...
if __name__ == '__main__':
    ...
    p.add_argument("--sparse_chkpt", type=str, default=None,)
    ...
    loaders, class_names = prepare_additive_data(args,dataset=args.dataset,data_path=data_path, preprocess=preprocess)
    ...
    # print % 
    print(f"Percentage of trainable params: {total_trainable_params/total_params*100:.2f}%")
