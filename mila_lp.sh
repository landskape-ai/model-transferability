...
#SBATCH -c 8
#SBATCH --job-name=LP_Mamba_C10
#SBATCH --mem=16G
#SBATCH --gres=gpu:rtx8000:1
#SBATCH --reservation=ubuntu1804
#SBATCH --signal=SIGUSR1@90 # 90 seconds before time limit
#SBATCH --output=$SCRATCH/lpmamba-%j.out
#SBATCH --error=$SCRATCH/lpmamba-%j.err

pyfile=/home/mila/d/diganta.misra/projects/model-transferability/experiments/cnn/linear_probing.py
